...
import {addTeamQuery, fetchAllTeamsQuery, getLastTeamIdQuery, fetchTeamQuery, updateTeamQuery, deleteTeamQuery} from "../model/teamQuery.js"
...
export const addTeam = async(req, res, next) =>{
    try {
        ...
        // let id = ''
        // let [team_data] = await getLastTeamIdQuery();

        // if (team_data.length == 0) {
        //     id = 'GSTMP000'
        // }else{
        //     id = team_data[0].team_id
        // }
        // const team_id = await incrementId(id)
